...
import {FaHtml5,FaCss3Alt,FaReact,FaNodeJs,FaGithub, FaJava, FaCopyright} from "react-icons/fa"
import {TbBrandJavascript} from "react-icons/tb"
import {SiMongodb,SiRedux,SiExpress,SiChakraui,SiNetlify,SiVercel, SiPython} from "react-icons/si"
...
const Skills = () => {
  ...
  return (
   ...
   <Grid templateColumns={['repeat(2, 1fr)','repeat(3, 1fr)','repeat(4, 1fr)','repeat(6, 1fr)']} gap={30} margin="auto"  textAlign="center" >
        ...
        <GridItem display={"grid"} justifyContent={"center"} gap="5px" ><Box boxShadow={"2xl"} p="30px" borderRadius={"10px"}><SiPython size={80} color={colorIcon}/> <Text fontWeight={"bold"}>Python</Text></Box></GridItem>
        <GridItem display={"grid"} justifyContent={"center"} gap="5px" ><Box boxShadow={"2xl"} p="30px" borderRadius={"10px"}><FaJava size={80} color={colorIcon}/> <Text fontWeight={"bold"}>Java</Text></Box></GridItem>
        <GridItem display={"grid"} justifyContent={"center"} gap="5px" ><Box boxShadow={"2xl"} p="30px" borderRadius={"10px"}><SiCplusplus size={80} color={colorIcon}/> <Text fontWeight={"bold"}>C++</Text></Box></GridItem>
        <GridItem display={"grid"} justifyContent={"center"} gap="5px" ><Box boxShadow={"2xl"} p="30px" borderRadius={"10px"}><FaCopyright size={80} color={colorIcon}/> <Text fontWeight={"bold"}>C</Text></Box></GridItem>
